...
export const devices = [
    ...
    {'name': 'HEGduino', id:'hegduino', company:'Brains@Play', analysis: [], variants: ['USB','Bluetooth'], cls: hegduinoPlugin, chromeOnly: true},
    {'name': 'FreeEEG32', id:'freeeg32', company:'Neuroidss', analysis: ['eegcoherence'], variants: ['2','19','2_optical','19_optical','19_ads131'], cls: eeg32Plugin, chromeOnly: true},
