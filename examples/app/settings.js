...
let particlesFragmentShader = document.querySelector('#particlesFragmentShader').innerHTML
let particlesVertexShader = document.querySelector('#particlesVertexShader').innerHTML
let desertGroundFragmentShader = document.querySelector('#desertGroundFragmentShader').innerHTML
let desertGroundVertexShader = document.querySelector('#desertGroundVertexShader').innerHTML
let invisisphereFragmentShader = document.querySelector('#invisisphereFragmentShader').innerHTML
let invisisphereVertexShader = document.querySelector('#invisisphereVertexShader').innerHTML
